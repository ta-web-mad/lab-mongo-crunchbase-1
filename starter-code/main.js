        ...
        switch (option) {
          ...
          case "4":
            ...
            db.collection('companies')
              .find({ $and: [{ founded_year: 2004 }, { founded_month: 2 }] }, { name: 1 })
          ...
          case "5":
            ...
            db.collection('companies')
              .find({ $and: [{ founded_year: 2004 }, { founded_month: { $gt: 3 } }, { founded_month: { $lt: 7 } }] }, { name: 1, founded_year: 1, founded_month: 1, founded_day: 1 })
          ...
          case "6":
            ...
            db.collection('companies').find({ offices: { $elemMatch: { city: "Barcelona" } } }, { name: 1 }).toArray((error, result) => {
              if (error) {
                console.log(error);
                rl.question(`\nType enter to continue: `, (answer) => { mainMenu() });
              } else {
          ...
          case "14":
            ...
            db.collection('companies').find({ tag_list: { $regex: /social-networking/i } }, { name: 1, tag_list: 1 }).toArray((error, result) => {
              if (error) {
                console.log(error);
                rl.question(`\nType enter to continue: `, (answer) => { mainMenu() });
              } else {
          ...
          case "15":
            ...
            db.collection('companies').find({ $and: [{ tag_list: { $regex: /social-networking/i } }, { founded_year: { $gte: 2002 } }, { founded_year: { $lte: 2016 } }] }, { name: 1, founded_year: 1 }).count((error, result) => {
              if (error) {
                console.log(error);
                rl.question(`\nType enter to continue: `, (answer) => { mainMenu() });
              } else {
          ...
          case "16":
            ...
            db.collection('companies').find({ offices: { $elemMatch: { city: "London" } } }, { name: 1, "offices.city": 1 }).toArray((error, result) => {
              if (error) {
                console.log(error);
                rl.question(`\nType enter to continue: `, (answer) => { mainMenu() });
              } else {
                result.forEach(elm => {
                  console.log(elm.name, elm.offices);
                })
                rl.question(`\nType enter to continue: `, (answer) => { mainMenu() });
              }
            })
          ...
          case "17":
            ...
            db.collection('companies').find({ $and: [{ tag_list: { $regex: /social-networking/i } }, { founded_year: { $gte: 2002 } }, { founded_year: { $lte: 2016 } }, { "offices.city": "New York" }] }).count((error, result) => {
              if (error) {
                console.log(error);
                rl.question(`\nType enter to continue: `, (answer) => { mainMenu() });
              } else {
