      ...
      rl.question('Type an option: ', (option) => {
        switch (option) {
          ...
          case "4":
            ...
            db.collection('companies').find({}, { $and: [{ founded_year: 2004 }, { founded_month: 02 }, { name: 1, _id: 0 }] }).toArray((error, result) => {
              if (error) {
                console.log(error);
                rl.question(`\nType enter to continue: `, (answer) => { mainMenu() });
              } else {
          ...
          case "5":
            ...
            db.collection('companies').find({}, { $and: [{ founded_year: 2004 }, { founded_month: { $gte: 04 } }, { founded_month: { $lte: 06 } }, { founded_month: 1, _id: 0 }] }).toArray((error, result) => {
              if (error) {
                console.log(error);
                rl.question(`\nType enter to continue: `, (answer) => { mainMenu() });
              } else {
          ...
          case "6":
            ...
            db.collection('companies').find({}, { "offices.city": {$in: ["Barcelona"] } }).toArray((error, result) => {
              if (error) {
                console.log(error);
                rl.question(`\nType enter to continue: `, (answer) => { mainMenu() });
              } else {
          ...
          case "9":
            ...
            db.collection('companies').find({}, { $and: [{ name: "Facebook" }, { number_of_employees }] }).count((error, result) => {
              if (error) {
                console.log(error);
                rl.question(`\nType enter to continue: `, (answer) => { mainMenu() });
              } else {
          ...
          case "12":
            ...
            db.collection('companies').find({}, { $and: [{ name: "Facebook" }, { "relationships.is_past": true }] }).count((error, result) => {
              if (error) {
                console.log(error);
                rl.question(`\nType enter to continue: `, (answer) => { mainMenu() });
              } else {
          ...
          case "14":
            ...
            break;
          case "15":
            //Names of the companies that has "social-networking" in tag-list 
          ...
          case "17":
            ...
            db.collection('companies').find({}, { "offices.city": { $in: ["London"] } }, { name: 1 }).toArray((error, result) => {
              if (error) {
                console.log(error);
                rl.question(`\nType enter to continue: `, (answer) => { mainMenu() });
              } else {
