      ...
      rl.question('Type an option: ', (option) => {
        switch (option) {
          ...
          case "11":
            ...
            db.collection('companies').find({ $and: [{ name: 'Facebook' }, { "relationships.is_past": false }] }, { "relationships.person.permalink": 1 }).toArray((error, result) => {
              if (error) {
                console.log(error);
                rl.question(`\nType enter to continue: `, (answer) => { mainMenu() });
              } else {
          ...
          case "12":
            ...
            db.collection('companies').find({ $and: [{ "relationships.person.permalink": "david-ebersman" }, { "relationships.is_past": true }] }, { name: 1 }).toArray((error, result) => {
              if (error) {
                console.log(error);
                rl.question(`\nType enter to continue: `, (answer) => { mainMenu() });
              } else {
          ...
          case "15":
            ...
            db.collection('companies').find({ $and: [{ tag_list: "social-networking" }, { founded_year: { $gte: 2002 } }, { founded_year: { $lte: 2016 } }] }).count((error, result) => {
              if (error) {
                console.log(error);
                rl.question(`\nType enter to continue: `, (answer) => { mainMenu() });
              } else {
          ...
          case "16":
            ...
            db.collection('companies').find({ "offices.city": 'London' }, { name: 1, offices: 1 }).toArray((error, result) => {
              if (error) {
                console.log(error);
                rl.question(`\nType enter to continue: `, (answer) => { mainMenu() });
              } else {
          ...
          case "17":
            ...
            db.collection('companies').find(and: [{ tag_list: "social-networking" }, { founded_year: { $gte: 2002 } }, { founded_year: { $lte: 2016 } }, { "offices.city": 'New York' }] }).count((error, result) => {
              if (error) {
                console.log(error);
                rl.question(`\nType enter to continue: `, (answer) => { mainMenu() });
              } else {
