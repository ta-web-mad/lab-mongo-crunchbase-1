      ...
      rl.question('Type an option: ', (option) => {
        switch (option) {
          ...
          case "7":
            ...
            db.collection('companies').find({}, { number_of_employees: 1, name: 1, _id: 0 }
          ...
          case "15":
            ...
            db.collection('companies').find(
              { tag_list: 'social-networking', $and: [{ founded_year: { $gt: 2002 } }, { founded_year: { $lt: 2016 } }] }
            ).count((error, result) => {
              if (error) {
                console.log(error);
                rl.question(`\nType enter to continue: `, (answer) => { mainMenu() });
          ...
          case "17":
            ...
            db.collection('companies').find(
              { tag_list: 'social-networking', $and: [{ founded_year: { $gt: 2002 } }, { founded_year: { $lt: 2016 } }, { 'offices.city': 'New York' }] }
            ).count((error, result) => {
              if (error) {
                console.log(error);
                rl.question(`\nType enter to continue: `, (answer) => { mainMenu() });
